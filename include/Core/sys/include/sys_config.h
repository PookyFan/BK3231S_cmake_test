 ...
 *
 * SOURCE CONTROL: $Id: sys_config.h,v 1.104 2011/01/19 17:24:30 garyf Exp $
 *
 * LICENCE:
...
extern void UART_Debug_TX_Char(u_int8 dat);

enum
	{
DEBUG_CHAR_PKA=1,
DEBUG_CHAR_NO_PKT_RCVD=2,
DEBUG_CHAR_PKD=3,
DEBUG_CHAR_SYNC=4,
DEBUG_CHAR_PKD_RX_HDR=5,
DEBUG_CHAR_Tx=6
};
